...
def random_test(times):
    ...
    for i in xrange(times):
        ...
        col = random.randint(30, 30)        
        row = random.randint(col, 30)
...
def static_test_ex():
    ...
    matrix = [
        [1,2,3,0,0,0,0,0,0, 6],
        [0,0,0,1,2,3,0,0,0, 10],
        [0,0,0,0,0,0,1,2,3, 15],
        [4,5,6,0,0,0,0,0,0, 21],
        [0,0,0,4,5,6,0,0,0, 19],
        [0,0,0,0,0,0,4,5,6, 18],
        [7,8,9,0,0,0,0,0,0, 10],
        [0,0,0,7,8,9,0,0,0, 2],
        [0,0,0,0,0,0,7,8,9, 21],
    ]    
    run_test(mod, solution, matrix)
